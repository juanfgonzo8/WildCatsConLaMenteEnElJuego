...
train_loader = DataLoader(train_dataset, batch_size=BS, shuffle=True, num_workers=50, pin_memory=True)
test_loader = DataLoader(test_dataset, batch_size=BS, shuffle=False, num_workers=50, pin_memory=True)
